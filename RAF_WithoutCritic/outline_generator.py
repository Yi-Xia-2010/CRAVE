...
def run_step_2_two_stage(api_key, world_data, arc_key, theme, genre, chapters_count="6"):
...
def main():
    ...
    json_str, raw_draft = run_step_2_two_stage(api_key, world_data, arc_choice, args.theme, args.genre, chapters_count=chapters_val)
