...
# Patterns for numbered labels like "Option 1:", "Outcome A:" that aren't character names
IGNORE_PATTERNS = [
...
def get_best_match(character_name, sprite_files):
    """
    Finds the filename in sprite_files that most closely matches character_name.
    Returns the filename (including extension) or None if no good match is found.
    """
